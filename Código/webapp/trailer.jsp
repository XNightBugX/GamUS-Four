...
<div class="column" id="center">
	<p id="title_trailer">Trailer de <c:out value="${sessionScope.name}"/></p>
	<iframe id="trailer" width="420" height="345" src="https://www.youtube.com/embed/<c:out value ="${sessionScope.videos}"/>">
	</iframe><br><br><br><br>
	<img src="./images/trailerimg.png" />
	</div>
